        ...
        <div className={`popup ${modalState ? 'active' : ''}`}>
          ...
          <form className='conatiner__create_series' onSubmit={handleCreateSeries}>
            <div className='select__container'>
              ...
              <p>{selectedBranchOffice ? series.find((s: {id: number}) => s.id === selectedBranchOffice)?.razon_social : 'Selecciona'}</p>
        ...
        {series ? (
          <div className='table__body'>
            {series.map((serie: BranchOffices) => {
              ...
              const sucursal = branchOffice.find((sucursal: {id: number}) => sucursal.id === serie.sucursal_id);
              return (
